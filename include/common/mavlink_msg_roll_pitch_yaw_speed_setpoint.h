...
static inline void mavlink_msg_roll_pitch_yaw_speed_setpoint_send(mavlink_channel_t chan, uint32_t time_ms, float roll_speed, float pitch_speed, float yaw_speed)
{
	...
	mavlink_msg_roll_pitch_yaw_speed_setpoint_pack_chan(mavlink_system.sysid, mavlink_system.compid, chan, &msg, time_ms, roll_speed, pitch_speed, yaw_speed);
...
{
	roll_pitch_yaw_speed_setpoint->time_ms = mavlink_msg_roll_pitch_yaw_speed_setpoint_get_time_ms(msg);
	roll_pitch_yaw_speed_setpoint->roll_speed = mavlink_msg_roll_pitch_yaw_speed_setpoint_get_roll_speed(msg);
	roll_pitch_yaw_speed_setpoint->pitch_speed = mavlink_msg_roll_pitch_yaw_speed_setpoint_get_pitch_speed(msg);
	roll_pitch_yaw_speed_setpoint->yaw_speed = mavlink_msg_roll_pitch_yaw_speed_setpoint_get_yaw_speed(msg);
}

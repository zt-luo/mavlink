...
static inline void mavlink_msg_roll_pitch_yaw_setpoint_send(mavlink_channel_t chan, uint32_t time_ms, float roll, float pitch, float yaw)
{
	...
	mavlink_msg_roll_pitch_yaw_setpoint_pack_chan(mavlink_system.sysid, mavlink_system.compid, chan, &msg, time_ms, roll, pitch, yaw);
...
{
	roll_pitch_yaw_setpoint->time_ms = mavlink_msg_roll_pitch_yaw_setpoint_get_time_ms(msg);
	roll_pitch_yaw_setpoint->roll = mavlink_msg_roll_pitch_yaw_setpoint_get_roll(msg);
	roll_pitch_yaw_setpoint->pitch = mavlink_msg_roll_pitch_yaw_setpoint_get_pitch(msg);
	roll_pitch_yaw_setpoint->yaw = mavlink_msg_roll_pitch_yaw_setpoint_get_yaw(msg);
}

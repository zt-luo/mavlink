...
static void mavlink_test_aux_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_aux_status_t packet_in = {
		17235,
	17339,
	17443,
	17547,
	...
	mavlink_aux_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.load = packet_in.load;
        	packet1.i2c0_err_count = packet_in.i2c0_err_count;
        	packet1.i2c1_err_count = packet_in.i2c1_err_count;
        	packet1.spi0_err_count = packet_in.spi0_err_count;
        	packet1.spi1_err_count = packet_in.spi1_err_count;
        	packet1.uart_total_err_count = packet_in.uart_total_err_count;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_aux_status_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_aux_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_aux_status_pack(system_id, component_id, &msg , packet1.load , packet1.i2c0_err_count , packet1.i2c1_err_count , packet1.spi0_err_count , packet1.spi1_err_count , packet1.uart_total_err_count );
	mavlink_msg_aux_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_aux_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.load , packet1.i2c0_err_count , packet1.i2c1_err_count , packet1.spi0_err_count , packet1.spi1_err_count , packet1.uart_total_err_count );
	mavlink_msg_aux_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_aux_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_aux_status_send(MAVLINK_COMM_1 , packet1.load , packet1.i2c0_err_count , packet1.i2c1_err_count , packet1.spi0_err_count , packet1.spi1_err_count , packet1.uart_total_err_count );
	mavlink_msg_aux_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_watchdog_process_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_watchdog_process_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	mav_array_memcpy(packet1.name, packet_in.name, sizeof(int8_t)*100);
        	mav_array_memcpy(packet1.arguments, packet_in.arguments, sizeof(int8_t)*147);
...
static void mavlink_test_pattern_detected(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_pattern_detected_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	mav_array_memcpy(packet1.file, packet_in.file, sizeof(int8_t)*100);
...
static void mavlink_test_point_of_interest(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_point_of_interest_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	mav_array_memcpy(packet1.name, packet_in.name, sizeof(int8_t)*25);
...
static void mavlink_test_visual_odometry(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_visual_odometry_t packet_in = {
		93372036854775807ULL,
	...
	mavlink_visual_odometry_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.frame1_time_us = packet_in.frame1_time_us;
        	packet1.frame2_time_us = packet_in.frame2_time_us;
        	packet1.x = packet_in.x;
        	packet1.y = packet_in.y;
        	packet1.z = packet_in.z;
        	packet1.roll = packet_in.roll;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_visual_odometry_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_visual_odometry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_visual_odometry_pack(system_id, component_id, &msg , packet1.frame1_time_us , packet1.frame2_time_us , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw );
	mavlink_msg_visual_odometry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_visual_odometry_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.frame1_time_us , packet1.frame2_time_us , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw );
	mavlink_msg_visual_odometry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_visual_odometry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_visual_odometry_send(MAVLINK_COMM_1 , packet1.frame1_time_us , packet1.frame2_time_us , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw );
	mavlink_msg_visual_odometry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_pixhawk(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_aux_status(system_id, component_id, last_msg);
	...
	mavlink_test_visual_odometry(system_id, component_id, last_msg);
}
